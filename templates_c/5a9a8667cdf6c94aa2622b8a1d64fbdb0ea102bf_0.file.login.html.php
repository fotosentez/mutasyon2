<?php
/* Smarty version 3.1.30, created on 2017-01-12 14:40:03
  from "/var/www/html/mutasyon2/view/login/login.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58776b13850983_58212872',
...
function content_58776b13850983_58212872 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="loginform">
                ...
                <div>
                    <div class="relative">
                        ...
                        <input type="text" class="input" name="username" value="deneme@deneme.com" />
                    </div>
                    <div class="relative">
                        <label><?php echo Lang::getLang("password");?>
</label><br />
                        <input type="password" class="input" name="password" value="deneme1" />
                        <input id="token" type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['makeToken']->value;?>
" name="token" />
                    </div>
                    <div class="buttondiv">
