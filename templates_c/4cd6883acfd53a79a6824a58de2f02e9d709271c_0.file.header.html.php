<?php
/* Smarty version 3.1.30, created on 2016-12-29 20:15:45
  from "/var/www/html/mutasyon2/view/default/header.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_586544c154ffc1_12838435',
...
function content_586544c154ffc1_12838435 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
                                        ...
                                        <div class="col-md-3 left_col">
                                            <div class="left_col scroll-view">
                                                <div class="navbar nav_title" style="border: 0;">
                                                    <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span><?php echo $_smarty_tpl->tpl_vars['siteName']->value;?>
</span></a>
                                                </div>
                                                    ...
                                                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                                                        ...
                                                        <div class="menu_section">
                                                            ...
                                                            <!--Invoices -->
                                                                <li>
                                                                    <a>
                                                                        <i class="fa fa-home"></i> <?php echo Lang::getLang('invoices');?>
                                                            ...
                                                            <!--Customers -->
                                                                <li>
                                                                    <a>
                                                                        <i class="fa fa-home"></i> <?php echo Lang::getLang('current');?>
                                                    ...
                                                    <div class="">
                                                        <div class="page-title">
                                                            <div class="title_left">
                                                                <h3><?php echo $_smarty_tpl->tpl_vars['pageDesc']->value;?>
</h3>
                                                            </div>
